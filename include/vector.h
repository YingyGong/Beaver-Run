...
/**
 * Project line1 onto line2.
 * 
 * @param line1 the line to be projected
 * @param line2 the line that we aim to project line1 onto
 * @return The projection of line1 onto line2
 */
vector_t vec_project(vector_t line1, vector_t line2);

/**
 * Check whether two vectors, v1 and v2, are opposite
 * 
 * @param v1 the first vector
 * @param v2 the second vector
 * @return a boolean value indicating whether v1 and v2 are opposite
 */
